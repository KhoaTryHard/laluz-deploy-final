      ...
      <form className="admin-form" onSubmit={handleSubmit}>
        ...
        <div className="form-group">
            ...
            <textarea 
                ...
                onChange={handleChange}
            ></textarea>
            <small style={{ color: '#888', fontStyle: 'italic' }}>Ảnh đầu tiên sẽ là ảnh đại diện.</small>
        </div>
        ...
        <div className="row">
            <div className="col-md-4">
                <div className="form-group">
                    ...
                    <input type="text" name="top_notes" placeholder="VD: Cam, Chanh" onChange={handleChange} />
                </div>
            </div>
            <div className="col-md-4">
                <div className="form-group">
                    <label>Hương giữa</label>
                    <input type="text" name="middle_notes" placeholder="VD: Hoa oải hương" onChange={handleChange} />
                </div>
            </div>
            <div className="col-md-4">
                <div className="form-group">
                    <label>Hương cuối</label>
                    <input type="text" name="base_notes" placeholder="VD: Gỗ đàn hương" onChange={handleChange} />
                </div>
            </div>
        </div>
